...
1. The *bypass* flow: start a flow with our bypass marker, then a story, then
   the tripwire text. The flow should be bypassed after the marker, so the
   tripwire text must not reach detection and must not alert. The client
   still verifies the echo, proving traffic kept flowing after the bypass.
