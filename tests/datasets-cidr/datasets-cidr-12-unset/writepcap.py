...
# 2 packets from 1.2.3.4 (pre-loaded as /32) - first unsets it, second does not match
...
# 2 packets from 5.6.7.8 (pre-loaded as /32) - first unsets it, second does not match
pkts.append(Ether(dst='ff:ff:ff:ff:ff:ff', src='00:01:02:03:04:05') /
...
# 1 packet from 9.9.9.9 (never in set) - does not match
pkts.append(Ether(dst='ff:ff:ff:ff:ff:ff', src='00:01:02:03:04:05') /
    IP(src='9.9.9.9', dst='8.8.8.8') /
