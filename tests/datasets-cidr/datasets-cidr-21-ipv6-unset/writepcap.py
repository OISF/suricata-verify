...
# 2 packets from fc00::1 (pre-loaded as /128) - first unsets it, second no longer matches
...
# 2 packets from 2001:db8::1 (pre-loaded as /128) - first unsets it, second no longer matches
pkts.append(Ether(dst='ff:ff:ff:ff:ff:ff', src='00:01:02:03:04:05') /
...
# 1 packet from fe80::1 (never in set) - does not match
pkts.append(Ether(dst='ff:ff:ff:ff:ff:ff', src='00:01:02:03:04:05') /
